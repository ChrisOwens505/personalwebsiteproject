...
try {
	...
	$cell = filter_input(INPUT_POST, "cell", FILTER_SANITIZE_STRING, FILTER_FLAG_NO_ENCODE_QUOTES);
	...
	echo "<div class=\"alert alert-danger\" role=\"alert\"><strong>What The Heck!</strong> Here's where you screwed up - " . $exception->getMessage() . "</div>";
}
...
<html>
	...
	<body class="text">
		<nav class="navbar navbar-expand-lg navbar-light bg-dark mb-3" >
			...
			<a class="navbar-brand text-light" href="https://bootcamp-coders.cnm.edu/~cowens17/personalwebsiteproject/public_html/documentation/milestone-1.php#!">My Personal Website</a>
			<div class="collapse navbar-collapse" id="navbarTogglerDemo02">
				<ul class="navbar-nav mr-auto mt-2 mt-md-0">
					<li class="nav-item active">
						<a class="nav-link text-light" href="documentation/christianowensresume.pdf">Résumé<span class="sr-only">(current)</span></a>
					</li>
					<li>
						<a class="nav-link text-light" href="https://github.com/ChrisOwens505">GitHub<span class="sr-only">(current)</span></a>
					</li>
					<li>
						<a class="nav-link text-light" href="https://www.linkedin.com/in/christian-owens-3930a2143/">LinkedIn<span class="sr-only">(current)</span></a>
					</li>
					<li>
						<a class="nav-link text-light" href="https://www.facebook.com/mr.mactastic">Facebook<span class="sr-only">(current)</span></a>
					</li>
					<li>
						<a class="nav-link text-light" href="https://twitter.com/C0derChris">Twitter<span class="sr-only">(current)</span></a>
					</li>
				</ul>
			</div>
		</nav>
					...
					<div class="card-deck">
						<div class="card text-white bg-dark mb-3">
							...
							<div class="card-body">
								...
								<p class="card-text">My name is Christian, I am Albuquerque born and raised, but currently conflicted with my high                                                 aspirations to travel. I have an individual passion for each subject I'm interested in, they include web development, psychology, and bio-technology. I plan to attend school and achieve a degree in bio-tech, and use my knowledge of web development to somehow integrate one into the other. My personal goal is
						...
						<div class="card text-white bg-dark mb-3">
							<img class="card-img-top" src="images/mexico.jpg" alt="Card image cap">
							<div class="card-body">
						...
						<div class="card text-white bg-dark mb-3">
							<img class="card-img-top" src="images/meanddad.jpg" alt="Card image cap">
							<div class="card-body">
	...
	<div class="row">
		<div class="col">
			<div class="card-deck">
				...
				<div class="card text-white bg-dark mb-3">
					<img class="card-img-bottom" src="images/meinmexico.jpg" >
					<div class="card-body">
						<h4 class="card-title">Contact Information</h4>
						<p class="card-text">If you would like to reach me regarding anything, I have provided some other ways you may contact me besides through my social media.</p>
						<ul>
							<li>Cellular Number : 505-610-6456</li>
							<li>Main Email Address : Chrisowens132@gmail.com</li>
							<li>CNM Email Address : Cowens17@cnm.edu</li>
						</ul>
						<p>Please, if you have any questions or concerns, don't hesitate to contact me as soon as possible. Thank you for visiting my personal website, you're time is greatly appreciated!</p>
						<p class="card-text"><small class="text-muted">Last Updated Nov. 2017</small></p>
					</div>
				</div>
			</div>
		</div>
		...
		<blockquote class="blockquote">
			<p class="mb-0">The best way to escape from your problem is to solve it.</p>
			<footer class="blockquote-footer">Jazz <cite title="Source Title">Cartier</cite></footer>
		</blockquote>
	</body>
</html>